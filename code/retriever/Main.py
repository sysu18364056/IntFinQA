    ...
    for _ in range(conf.epoch):
        ...
        for x in train_iterator:
            ...
            this_logits = model(True, input_ids, input_mask,
                                segment_ids, intent_input_ids,intent_input_mask,intent_segment_ids,device=conf.device)
...
def evaluate(data_ori, data, model, ksave_dir, mode='valid'):
    ...
    with torch.no_grad():
        for x in tqdm(data_iterator):
            ...
            logits = model(True,input_ids,input_mask,segment_ids,intent_input_ids,intent_input_mask,intent_segment_ids,device=conf.device)
