...
class DataLoader:
    ...
    def get_batch(self):
        ...
        for each_data in self.data[start_index: end_index]:
            ...
            batch_data["intent_input_ids"].append(each_data["intent_input_ids"])
            batch_data["intent_input_mask"].append(each_data["intent_input_mask"])
            batch_data["intent_segment_ids"].append(each_data["intent_segment_ids"])
