...
class MathQAExample(
        collections.namedtuple(
            "MathQAExample",
            "id original_question question_tokens deep_intent options answer \
...
class InputFeatures(object):
    ...
    def __init__(self,
        ...
        self.intent_input_mask = intent_input_mask
...
def convert_single_mathqa_example(example, is_training, tokenizer, max_seq_length,
    ...
    intent_tokens=tokenize(tokenizer,example.deep_intent)
...
def read_mathqa_entry(entry, tokenizer):
    ...
    question=entry["qa"]["question"]
    #question=entry["qa"]["question"]+primary_intent
    this_id = entry["id"]
    context = ""
